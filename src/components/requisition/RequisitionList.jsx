import { Table, Input, Button, Icon ,Badge, Menu,Popconfirm,message} from 'antd';
...
class RequisitionList extends Component{
    ...
    expandedRowRender = (record) => {
        ...
        const columns = [                                     //扩展列表
            ...
            { title: '影像图编号', dataIndex: 'picture_number',  },
            { title: '厚度', dataIndex: 'picture_thickness',  },
            { title: '级别', dataIndex: 'picture_level',  },
    ...
    columns = [                     //最外层列表
        { title: '来样编号', dataIndex: 'requisition_number',  ...this.getColumnSearchProps('requisition_number'),},
        { title: '工程编号', dataIndex: 'requisition_name',  ...this.getColumnSearchProps('requisition_name'),},
        { title: '结构名称', dataIndex: 'requisition_structurename', ...this.getColumnSearchProps('requisition_structurename'), },
        { title: '施工单位', dataIndex: 'requisition_constructunit', ...this.getColumnSearchProps('requisition_constructunit'),},
        { title: '钢号', dataIndex: 'requisition_steelnumber',  ...this.getColumnSearchProps('requisition_steelnumber'),},
        { title: '焊接方法', dataIndex: 'requisition_weldingmethod', ...this.getColumnSearchProps('requisition_weldingmethod'),},
        { title: '厚度', dataIndex: 'requisition_density', ...this.getColumnSearchProps('requisition_density'),},
        { title: '检测标准', dataIndex: 'requisition_testingstandard', ...this.getColumnSearchProps('requisition_testingstandard'),},
        { title: '合格级别', dataIndex: 'requisition_qualificationlevel', ...this.getColumnSearchProps('requisition_qualificationlevel'),},
        { title: '焊缝数量', dataIndex: 'requisition_totalnumber', ...this.getColumnSearchProps('requisition_totalnumber'),},
        { title: '一级状态', key: 'state1', render: (record) => <span><Badge status={record.firstStatus} />{record.requisition_firstexam}</span> },
        { title: '二级状态', key: 'state2', render: (record) => <span><Badge status={record.secondStatus}/>{record.requisition_secondexam}</span> },
